        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                La Villa ha una superficie interna di oltre <strong>240 mq</strong>, suddivisa in grandi ambienti di <strong>lusso</strong> esclusivi: tre <strong>camere</strong>, un grande <strong>soggiorno</strong>, due <strong>bagni</strong> e una <strong>cucina</strong> a totale disposizione. E' disposta su due piani e può ospitare comodamente fino a sei persone, permettendo a ognuna la sua più completa privacy.
              </p>
            </div>
            <Button 
              variant="outline" 
